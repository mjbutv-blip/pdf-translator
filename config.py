...
WORKER_HEARTBEAT_SECONDS = max(5, _int_secret_or_env("WORKER_HEARTBEAT_SECONDS", 15))
WORKER_STALE_SECONDS = max(WORKER_HEARTBEAT_SECONDS * 3, _int_secret_or_env("WORKER_STALE_SECONDS", 75))
